...
- **Via OData** (when an OData connection is configured): agent calls `POST /fmi/odata/v4/{database}/Script/{ScriptName}` — this is the preferred path for a fully autonomous closed loop
